    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (result!=null){
            if (result.getContents()==null){
                Toast.makeText(CameraActivity.this,"You cancelled the scanning",Toast.LENGTH_LONG).show();
            }else {
                ...
                Toast.makeText(CameraActivity.this,result.getContents(),Toast.LENGTH_LONG).show();
            }
        }
